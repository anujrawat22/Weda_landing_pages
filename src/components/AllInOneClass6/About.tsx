        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          >
            ...
            <div className="text-gray-600 leading-relaxed space-y-4">
              ...
              <motion.p variants={itemVariants}>
                Driven by his motto, Excellence through Hard Work and Dedication , Col Singh keeps motivating the WEDA staff to maintain the highest academic standards, discipline, and professional integrity.
              </motion.p>
            </div>
